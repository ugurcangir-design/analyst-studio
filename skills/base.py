...
added / updated / removed olabilir."""
    ...
    "gorev_teknik_analiz": {
        ...
        "icerik": (
            ...
            "# SEÇİLEBİLİR BÖLÜMLER (yalnızca ilgili olanları, bu sırayla)\n"
            "- `## Gereksinim` — 1 cümle: geliştiriciden tam olarak ne isteniyor. (Neredeyse her görevde.)\n"
            "- `## Çözüm` — SOMUT yapılacak iş: hangi servis/endpoint/alan/ekran, NASIL kullanılacak, "
            "adımlar. Gözlenen servisleri burada ÇÖZÜM olarak kullan. Hem FE hem BE etkileniyorsa kısaca "
            "AYIR (FE / BE). Yeni endpoint/alan/DB YALNIZCA gerçekten gerekiyorsa; kaynağı/gözlemi "
            "olmadan İCAT ETME.\n"
